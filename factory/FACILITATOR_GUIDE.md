# Facilitator Guide — Factory (Predictive Maintenance)
...
| 0:15 – 0:35 | **Challenge 1: Build** | Create both agents, test with sensor data |
...
| 1:00 – 1:15 | **Challenge 4: Workflow** | Wire agents into an automated factory health pipeline |
